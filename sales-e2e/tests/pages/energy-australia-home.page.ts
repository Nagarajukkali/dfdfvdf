...
const eaHomePage = {
  ...
  elements: {
    ...
    ResidentialBalanceTable: {
      residentialBalanceTitle: Selector("[id*='plan-heading-title-BASE_TAPR1-']"),
      residentialBalanceFuel: Selector("[id*='plan-heading-fuel-BASE_TAPR1-']"),
      ...
      residentialBalanceHeadingDescription : Selector("[id*='plan-heading-description-BASE_TAPR1-']"),
