...
const eaCheckoutDetailsPage={
  elements: {
    ...
    titleTag:Selector("div[title*='Please select'] sui-option"),
    ...
    stateOfIssue:Selector('#id_state sui-select'),
    stateOfIssueDropdown:Selector('#id_state sui-select sui-option'),
    ...
    rbBillPrefEmail: Selector("#bill-delivery-method__email-option div"),
    rbBillPrefConnectionAddress: Selector("#bill-delivery-method__connection-address-option div"),
