...
#    And user selects "single_rate" solar tariff type for "<state>"
    ...
    Examples:
      ...
      | New            | BOTH     |Solar Max & Flexi Plan| 0           | 25           | solarmax | E2E_solar-flexi-plan_VIC_new_moving | VIC   | single_rate| Quote Tool   | Move Home | No  | No | RES          | New           |
...
#    And user selects "single_rate" solar tariff type for "<state>"
    ...
    Examples:
      | customerStatus | fuelType |planName              | eleDiscount | gasDiscount| campaign | folderName                        | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     |Solar Max & Flexi Plan| 0           | 25          | solarmax    | E2E_solar-flexi-plan_VIC_new_non_moving | VIC   | Quote Tool   | COR   | No  | No | RES          | New           |
...
#    And user selects "single_rate" solar tariff type for "<state>"
    ...
    Examples:
      | customerStatus | fuelType |planName              | eleDiscount | gasDiscount | campaign | folderName                                 | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     |Solar Max & Flexi Plan| 0           | 25           | solarmax | E2E_solar-flexi-plan_VIC_existing_non-moving | VIC   | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
...
#    And user selects "single_rate" solar tariff type for "<state>"
    ...
    Examples:
      | customerStatus | fuelType |planName              | eleDiscount | gasDiscount | campaign | folderName                             | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     |Solar Max & Flexi Plan| 0           | 25           | solarmax    | E2E_solar-flexi-plan_VIC_existing_moving | VIC   | Quote Tool   | Move Home | No  | No | RES          | Existing  non-moving |
