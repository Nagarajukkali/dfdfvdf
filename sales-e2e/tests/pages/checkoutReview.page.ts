...
const eaCheckoutReviewPage = {
  elements: {
    ...
    eleFeatureRPO: Selector("#reviewSectionEle [id*='benefit-text']").withText("Regular pay option"),
    ...
    gasFeature50Credit: Selector("#reviewSectionGas [id*='benefit-text']").withText(/[C|c]redit/),
    gasFeatureCN: Selector("#reviewSectionGas [id*='benefit-text']").withText("neutral"),
    gasFeatureRPO: Selector("#reviewSectionGas [id*='benefit-text']").withText("Regular pay option"),
