...
#      | GAS      | Y                | Y                     | N                   | Y                                  |  <state> |
    ...
    Examples:
      ...
      | New            | BOTH     | 5           | 8           | get-elec | E2E_Campaign_get-elec_NSW_new_moving | NSW   | Quote Tool   | Move Home | No  | No | RES          | New           |
...
#      | GAS      | Y                | Y                     | N                   | Y                                  |  <state> |
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                              | state | sourceSystem | journey | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 5           | 8           | get-elec | E2E_Campaign_get-elec_NSW_new_nonmoving | NSW   | Quote Tool   | COR     | No  | No | RES          | New           |
...
#      | GAS      | Y                | Y                     | N                   | Y                                  |  <state> |
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                                   | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting |
      | Existing       | BOTH     | 5           | 8           | get-elec | E2E_Campaign_get-elec_NSW_existing_nonmoving | NSW   | Quote Tool   | Plan Switch | No  | No | RES          | Existing      |
