...
Feature:E2E scenario for movehouse campaign
  ...
  Scenario Outline: Validate complete data for movehouse campaign for NSW - new non moving customer
    ...
    And user validates below mandatory fields
      ...
      |ELE     |VERBALLYACCEPTED|RESIDENTIAL |COR      |TOPH-EN |4102747329|                             |                             |N                      |                        |EMAIL        |<customerStatus>  |<campaign>|
    And user validates all the details for 'GAS' submitted quote
    And user validates below mandatory fields
      |fuelType|quoteStatus     |customerType|offerType|planCode|MIRN      |renovationsSinceDeenergisation|renovationsInProgressOrPlanned|customerWithLifeSupport|lifeSupportEquipmentType|billRouteType|customerStatus    |campaign  |
      |GAS     |VERBALLYACCEPTED|RESIDENTIAL |COR      |TOPH-GN |5240080109|                             |                             |N                      |                        |EMAIL        |<customerStatus>  |<campaign>|
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign      |folderName                                |state|sourceSystem  |journey  |AAH  |DD  |customerType |newOrExisting  |
      |New           |BOTH    |18         |16         |movehouse     |E2E_Campaign_movehouse_NSW_new_nonmoving  |NSW  |Quote Tool    |COR      |No   |No  |RES          |New            |
  ...
  Scenario Outline: Validate complete data for movehouse campaign for NSW existing non moving
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign    |folderName                                       |state|sourceSystem  |journey    |AAH  |DD  |customerType |newOrExisting        |
      |Existing      |BOTH    |18         |16         |movehouse |E2E_Campaign_movehouse_NSW_existing_non-moving |NSW  |Quote Tool    |Plan Switch|No   |No  |RES          |Existing  non-moving |
