...
Feature:E2E scenario for elec-tpp campaign
  ...
  Scenario Outline: Validate complete data for elec-tpp campaign for NSW
    ...
    And user validates the data on plans page for "<campaign>"
      |fuelType |Feature_50Credit  |Feature_carbonNeutral   |Feature_peaceOfMind  |Feature_VIPDiscountOffTotalEnergyBill   |Feature_noStandardConnectionFee  |
      |ELE      |N                 |Y                       |Y                    |Y                                       |N                                |
    ...
    And user validates plan details on cart page for "<campaign>"
      |fuelType |Feature_50Credit  |Feature_carbonNeutral   |Feature_peaceOfMind  |Feature_VIPDiscountOffTotalEnergyBill   |
      |ELE      |N                 |Y                       |Y                    |Y                                    |
    ...
    And user validates below mandatory fields
      ...
      |ELE     |VERBALLYACCEPTED|RESIDENTIAL |ENE      |SWSR1-EN |4311150544|N                             |N                             |Y                      |LSCNSPE                 |EMAIL        |

    Examples:
      |customerStatus|fuelType|eleDiscount|campaign  |folderName                 |state|sourceSystem  |journey  |AAH  |DD  |customerType |newOrExisting  |
      |New           |ELE     |18          |elec-tpp  |E2E_Campaign_elec-tpp_NSW  |NSW  |Quote Tool    |Move Home|No   |No  |RES          |New            |
  ...
  Scenario Outline: Validate complete data for elec-tpp campaign for NSW
    ...
    And user validates below mandatory fields
      |fuelType|quoteStatus     |customerType|offerType|planCode|NMI       |renovationsSinceDeenergisation|renovationsInProgressOrPlanned|customerWithLifeSupport|lifeSupportEquipmentType|billRouteType|
      |ELE     |VERBALLYACCEPTED|RESIDENTIAL |ENE      |SWSR1-ES |2002332288|N                             |N                             |Y                      |LSCNSPE                 |EMAIL        |

    Examples:
      |customerStatus|fuelType|eleDiscount|campaign  |folderName                 |state|sourceSystem  |journey  |AAH  |DD  |customerType |newOrExisting  |
      |New           |ELE     |7          |elec-tpp  |E2E_Campaign_elec-tpp_SA  |SA  |Quote Tool    |Move Home|No   |No  |RES          |New            |

  Scenario Outline: Validate complete data for elec-tpp campaign for VIC
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    ...
    And user validates below mandatory fields
      |fuelType|quoteStatus     |customerType|offerType|planCode|NMI       |renovationsSinceDeenergisation|renovationsInProgressOrPlanned|customerWithLifeSupport|lifeSupportEquipmentType|billRouteType|
      |ELE     |VERBALLYACCEPTED|RESIDENTIAL |ENE      |SWSR1-EV |6001456296|N                             |N                             |Y                      |LSCNSPE                 |EMAIL        |

    Examples:
      |customerStatus|fuelType|eleDiscount|campaign  |folderName                 |state|sourceSystem  |journey  |AAH  |DD  |customerType |newOrExisting  |
      |New           |ELE     |12          |elec-tpp  |E2E_Campaign_elec-tpp_VIC  |VIC  |Quote Tool    |Move Home|No   |No  |RES          |New            |
