...
const eaHomePage = {
  ...
  campaignElements: {
    ...
    //eleFeature200CreditTitle: Selector("[id*='plan-feature'][id*='-E'] [class*='hs-plan-feature__item-title']").withText("credit"),
    //eleFeature200CreditDescription: Selector("[id*='plan-feature'][id*='-E'] [class*='hs-plan-feature__item-title']").withText("credit").sibling(),
    ...
    //gasFeature200CreditTitle: Selector("[id*='plan-feature'][id*='-G'] [class*='hs-plan-feature__item-title']").withText(/[C|c]redit/),
    //gasFeature200CreditDescription: Selector("[id*='plan-feature'][id*='-G'] [class*='hs-plan-feature__item-title']").withText(/[C|c]redit/).sibling(),
