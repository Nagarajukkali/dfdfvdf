...
#  And user validates "GAS" discount to be "<gasDiscount>" percent for "<planName>" plan
  ...
  Examples:
    ...
    |New           |BOTH    |Balance Plan |5           |8          |balance    | NSW   |E2E_resi-bal-plan_NSW_new_moving   |Quote Tool  |Move Home|NSW    |RES          |New            |No  |No  |

  @DR22.10.2.campaign
  Scenario Outline: Validate complete data for residential-balance-plan for QLD - new moving customer
    Given user has opened the 'residential-home-page' link in a browser and creates '<folderName>' to save evidences
    And user has navigated to 'RES' plans page
    ...
    Examples:
      ...
      | New            | ELE      |Balance Plan| 0           | balance    | E2E_resi-balance-plan_QLD_new_moving | QLD   | Quote Tool   | Move Home | No  | No | RES          | New           |

  @DR22.10.2.campaign
  Scenario Outline: Validate complete data for residential-balance-plan for SA - new non moving
    Given user has opened the 'residential-home-page' link in a browser and creates '<folderName>' to save evidences
    And user has navigated to 'RES' plans page
...
#    And user validates "GAS" discount to be "<gasDiscount>" percent for "<planName>" plan
    ...
    Examples:
      ...
      | New            | BOTH     |Balance Plan| 0           | 4           | balance    | E2E_resi-balance-plan_SA_new_nonmoving | SA    | Quote Tool   | COR     | No  | No | RES          | New           |

  @DR22.10.2.campaign
  Scenario Outline: Validate complete data for residential-balance-plan for ACT - new moving
    Given user has opened the 'residential-home-page' link in a browser and creates '<folderName>' to save evidences
    And user has navigated to 'RES' plans page
    ...
    Examples:
      | customerStatus | fuelType |planName    | eleDiscount | gasDiscount | campaign | folderName                        | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | ELE      |Balance Plan| 6           | 9           | balance    | E2E_resi-balance-plan_ACT_new_moving | ACT   | Quote Tool   | Move Home | No  | No | RES          | New           |

  @DR22.10.2.campaign
  Scenario Outline: Validate complete data for residential-balance-plan for ACT - new non-moving
    Given user has opened the 'residential-home-page' link in a browser and creates '<folderName>' to save evidences
    And user has navigated to 'RES' plans page
    And user enters '2600' in 'POSTCODE' field
    And user validates "ELE" discount to be "<eleDiscount>" percent for "<planName>" plan
...
#    And user selects answer for property renovation question for '<state>'
    ...
    Examples:
      | customerStatus | fuelType |planName  | eleDiscount | gasDiscount | campaign | folderName                             | state | sourceSystem | journey | AAH | DD | customerType | newOrExisting |
      | New            | ELE      |Balance Plan| 6           | 9           | balance    | E2E_resi-balance-plan_ACT_new_nonmove | ACT   | Quote Tool   | COR     | No  | No | RES          | New           |

  @DR22.10.2.campaign
  Scenario Outline: Validate complete data for residential-balance-plan for ACT - existing non-moving
    Given user has opened the 'residential-home-page' link in a browser and creates '<folderName>' to save evidences
    And user has navigated to 'RES' plans page
    And user enters '2600' in 'POSTCODE' field
    And user validates "ELE" discount to be "<eleDiscount>" percent for "<planName>" plan
...
#    And user validates "GAS" discount to be "<gasDiscount>" percent for "<planName>" plan
    ...
    Examples:
      | customerStatus | fuelType |planName  | eleDiscount | gasDiscount | campaign | folderName                        | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     |Balance Plan| 5           | 12          | balance    | E2E_resi-balance-plan_VIC_new_non_moving | VIC   | Quote Tool   | COR   | No  | No | RES          | New           |

  @DR22.10.2.campaign
  Scenario Outline: Validate complete data for residential-balance-plan for NSW-Endeavour - new non moving customer
    Given user has opened the 'residential-home-page' link in a browser and creates '<folderName>' to save evidences
    And user has navigated to 'RES' plans page
...
#    And user validates "GAS" discount to be "<gasDiscount>" percent for "<planName>" plan
    ...
    Examples:
      | customerStatus | fuelType |planName  | eleDiscount | gasDiscount | campaign | folderName                             | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     |Balance Plan| 5           | 12           | balance    | E2E_resi-balance-plan_VIC_existing_moving | VIC   | Quote Tool   | Move Home | No  | No | RES          | Existing  non-moving |

  @DR22.10.2.campaign
  Scenario Outline: Validate complete data for residential-balance-plan for NSW-Endeavour existing non moving
    Given user has opened the 'residential-home-page' link in a browser and creates '<folderName>' to save evidences
    And user has navigated to 'RES' plans page
...
#      | <customerStatus> | 6942134043    | Postcode            | 2529             | dob    | 01011980 |
    ...
    Examples:
      | customerStatus | fuelType |planName  | eleDiscount | gasDiscount | campaign | folderName                                 | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     |Balance Plan| 5           | 8          | balance    | E2E_resi-balance-plan_NSW_existing_non-moving | NSW   | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |

  @DR22.10.2.campaign
  Scenario Outline: Validate complete data for residential-balance-plan for SA existing non moving
    Given user has opened the 'residential-home-page' link in a browser and creates '<folderName>' to save evidences
    And user has navigated to 'RES' plans page
...
#    And user validates "GAS" discount to be "<gasDiscount>" percent for "<planName>" plan
    ...
    Examples:
      | customerStatus | fuelType |planName  | eleDiscount | gasDiscount | campaign | folderName                                | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     |Balance Plan| 0           | 4          | balance    | E2E_resi-balance-plan_SA_existing_non-moving | SA    | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |

  @DR22.10.2.campaign
  Scenario Outline: Validate complete data for residential-balance-plan for QLD existing non moving
    Given user has opened the 'residential-home-page' link in a browser and creates '<folderName>' to save evidences
    And user has navigated to 'RES' plans page
    ...
    Examples:
      | customerStatus | fuelType |planName  | eleDiscount | campaign | folderName                                 | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | ELE      |Balance Plan| 0           | balance    | E2E_resi-balance-plan_QLD_existing_non-moving | QLD   | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
