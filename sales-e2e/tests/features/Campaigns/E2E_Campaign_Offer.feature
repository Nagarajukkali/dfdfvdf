...
Feature:E2E scenario for offer campaign
  ...
  Scenario Outline: Validate complete data for offer campaign for ACT
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign  |folderName             |state|sourceSystem  |journey  |AAH  |DD  |customerType |newOrExisting  |
      |New           |BOTH    |9          |9         |offer     |E2E_Campaign_Offer_ACT  |ACT  |Quote Tool    |Move Home|No   |No  |RES          |New            |
  ...
  Scenario Outline: Validate complete data for offer campaign for VIC
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign  |folderName             |state|sourceSystem  |journey  |AAH  |DD  |customerType |newOrExisting  |
      |New           |BOTH    |11         |27         |offer     |E2E_Campaign_Offer_VIC |VIC  |Quote Tool    |Move Home|No   |No  |RES          |New            |
  ...
  Scenario Outline: Validate complete data for offer campaign for QLD
    ...
    Examples:
      ...
      |New           |ELE     |13         |offer     |E2E_Campaign_Offer_QLD |QLD  |Quote Tool    |Move Home|No   |No  |RES          |New            |
  ...
  Scenario Outline: Validate complete data for offer campaign for SA
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign  |folderName           |state|sourceSystem  |journey  |AAH  |DD  |customerType |newOrExisting  |
      |New           |BOTH    |6         |15         |offer     |E2E_Campaign_Offer_SA |SA   |Quote Tool    |Move Home|No   |No  |RES          |New            |
