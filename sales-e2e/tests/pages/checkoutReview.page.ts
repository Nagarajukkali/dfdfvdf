...
const eaCheckoutReviewPage={
    elements: {
      ...
      eleFeatureDiscountOffTotal: Selector("#reviewSectionEle [id*='benefit-text']").withText(/Discount off total energy bill/i),
      ...
      gasFeatureDiscountOffTotal: Selector("#reviewSectionGas [id*='benefit-text']").withText(/Discount off total energy bill/i),
