...
const eaCheckoutReviewPage={
    elements: {
      ...
      eleFeatureDiscountOffTotal: Selector("#reviewSectionEle [id*='benefit-text']").withText(/[D|d]iscount off total energy bill/),
      ...
      gasFeatureDiscountOffTotal: Selector("#reviewSectionGas [id*='benefit-text']").withText(/[D|d]iscount off total energy bill/),
