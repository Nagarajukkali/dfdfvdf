...
Feature:E2E scenario for offer-canstarblue campaign
  ...
  Scenario Outline: Validate complete data for offer-canstarblue campaign for NSW-Ausgrid - new moving customer
    ...
    Examples:
      ...
      | New            | ELE      | 20          | 16          | offer-canstarblue  | E2E_Campaign_offer-CB_NSW_new_moving | NSW   | Quote Tool   | Move Home | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for offer-canstarblue campaign for QLD - new moving customer
    ...
    Examples:
      ...
      | New            | ELE      | 12          | offer-canstarblue    | E2E_Campaign_offer-CB_QLD_new_moving | QLD   | Quote Tool   | Move Home | No  | No | RES          | New           |
...
#      | GAS      | N                | Y                     | N                   | Y                   | Y                                     | <state> |    N                 |
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                          | state | sourceSystem | journey | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 6           | 15          | offer-canstarblue    | E2E_Campaign_offer-CB_SA_new_nonmoving | SA    | Quote Tool   | COR     | No  | No | RES          | New           |
...
#      | GAS      | N                | Y                     | N                   | Y                   | Y                                     | <state> |    N                 |
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                        | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | ELE      | 10          | 15          | offer-canstarblue    | E2E_Campaign_offer-CB_ACT_new_moving | ACT   | Quote Tool   | Move Home | No  | No | RES          | New           |
  @DR22.5.5.campaign
...
#    And user selects answer for property renovation question for '<state>'
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                             | state | sourceSystem | journey | AAH | DD | customerType | newOrExisting |
      | New            | ELE      | 10          | 15          | offer-canstarblue    | E2E_Campaign_offer-CB_ACT_new_nonmove | ACT   | Quote Tool   | COR     | No  | No | RES          | New           |
...
#      | GAS      | N                | Y                     | N                   | Y                   | Y                                     | <state> |    N                 |
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                             | state | sourceSystem | journey | AAH | DD | customerType | newOrExisting |
      | Existing       | ELE      | 10          | 15          | offer-canstarblue    | E2E_Campaign_offer-CB_ACT_Exs_nonmove | ACT   | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
  ...
  Scenario Outline: Validate complete data for offer-canstarblue campaign for VIC - new moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                        | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 12          | 33          | offer-canstarblue    | E2E_Campaign_offer-CB_VIC_new_moving | VIC   | Quote Tool   | Move Home | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for offer-canstarblue campaign for VIC - new non-moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                        | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 12          | 33          | offer-canstarblue    | E2E_Campaign_offer-CB_VIC_new_non_moving | VIC   | Quote Tool   | COR   | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for offer-canstarblue campaign for NSW-Endeavour - new non moving customer
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                           | state | sourceSystem | journey | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 16          | 16          | offer-canstarblue    | E2E_Campaign_offer-CB_NSW_new_nonmoving | NSW   | Quote Tool   | COR     | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for offer-canstarblue campaign for VIC existing non moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                                 | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     | 12          | 33          | offer-canstarblue    | E2E_Campaign_offer-CB_VIC_existing_non-moving | VIC   | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
  ...
  Scenario Outline: Validate complete data for offer-canstarblue campaign for VIC existing moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                             | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     | 12          | 33          | offer-canstarblue    | E2E_Campaign_offer-CB_VIC_existing_moving | VIC   | Quote Tool   | Move Home | No  | No | RES          | Existing  non-moving |
...
#    And user moves on to fill the qualifier
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                                 | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     | 16          | 16          | offer-canstarblue    | E2E_Campaign_offer-CB_NSW_existing_non-moving | NSW   | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
...
#      | GAS      | N                | Y                     | N                   | Y                   | Y                                     | <state> |    N                 |
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                                | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     | 6           | 15          | offer-canstarblue    | E2E_Campaign_offer-CB_SA_existing_non-moving | SA    | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
  ...
  Scenario Outline: Validate complete data for offer-canstarblue campaign for QLD existing non moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | campaign | folderName                                 | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | ELE      | 12          | offer-canstarblue    | E2E_Campaign_offer-CB_QLD_existing_non-moving | QLD   | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
