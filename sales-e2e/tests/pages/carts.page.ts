...
const cartsPage = {
  elements: {
    ...
    eleFeatureFFCN: Selector("#cart-plan-ELE .cart-plan__details-text").withText("Energy with a bit of good"),
    ...
    gasFeatureFFCN: Selector("#cart-plan-GAS .cart-plan__details-text").withText("Energy with a bit of good"),
