...
Feature:E2E scenario for basic-home campaign
    ...
    Scenario Outline: Validate complete data for basic-home campaign for NSW
        ...
        Examples:
            ...
            | New            | BOTH     | No          | No          | basic-home | E2E_Campaign_basicHome_NSW | NSW   | Quote Tool   | COR     | No  | No | RES          | New           |


    Scenario Outline: Validate complete data for basic-home campaign for ACT
        Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
        ...
        Examples:
            | customerStatus | fuelType | eleDiscount | gasDiscount | campaign   | folderName                 | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
            | New            | BOTH     | No          | No          | basic-home | E2E_Campaign_basicHome_ACT | ACT   | Quote Tool   | Move Home | No  | No | RES          | New           |

    Scenario Outline: Validate complete data for basic-home campaign for SA
        Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
        ...
        Examples:
            | customerStatus | fuelType | eleDiscount | gasDiscount | campaign   | folderName                | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
            | New            | BOTH     | No          | No          | basic-home | E2E_Campaign_basicHome_SA | SA    | Quote Tool   | Move Home | No  | No | RES          | New           |
