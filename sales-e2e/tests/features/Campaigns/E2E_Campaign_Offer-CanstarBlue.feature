...
Feature:E2E scenario for offer-canstarblue campaign
  ...
  Scenario Outline: Validate complete data for offer-canstarblue campaign for NSW
    ...
    Examples:
      ...
      |New           |BOTH    |17         |17         |offer-canstarblue     |E2E_Campaign_Offer-CanstarBlue_NSW  |NSW  |Quote Tool    |Move Home|No   |No  |RES          |New            |


  Scenario Outline: Validate complete data for offer-canstarblue campaign for ACT
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign              |folderName                          |state|sourceSystem  |journey  |AAH  |DD  |customerType |newOrExisting  |
      |New           |BOTH    |9          |9          |offer-canstarblue     |E2E_Campaign_Offer-CanstarBlue_ACT  |ACT  |Quote Tool    |Move Home|No   |No  |RES          |New            |


  Scenario Outline: Validate complete data for offer-canstarblue campaign for VIC
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign              |folderName                         |state|sourceSystem  |journey  |AAH  |DD  |customerType |newOrExisting  |
      |New           |BOTH    |11         |27         |offer-canstarblue     |E2E_Campaign_Offer-CanstarBlue_VIC |VIC  |Quote Tool    |Move Home|No   |No  |RES          |New            |


  Scenario Outline: Validate complete data for offer-canstarblue campaign for QLD
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    ...
    Examples:
      ...
      |New           |ELE     |13         |offer-canstarblue     |E2E_Campaign_Offer-CanstarBlue_QLD |QLD  |Quote Tool    |Move Home|No   |No  |RES          |New            |

  Scenario Outline: Validate complete data for offer-canstarblue campaign for SA
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign             |folderName                        |state|sourceSystem  |journey  |AAH  |DD  |customerType |newOrExisting  |
      |New           |BOTH    |6          |15         |offer-canstarblue    |E2E_Campaign_Offer-CanstarBlue_SA |SA   |Quote Tool    |Move Home|No   |No  |RES          |New            |
