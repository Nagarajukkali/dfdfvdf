...
Feature:E2E scenario for cashrewards campaign
  ...
  Scenario Outline: Validate complete data for cashrewards campaign for NSW - new moving customer
    ...
    Examples:
      ...
      |New           |BOTH    |24         |24         |cashrewards     |E2E_Campaign_cashrewards_NSW_new_moving  |NSW  |Quote Tool    |Move Home|No   |No  |RES          |New            |
  ...
  Scenario Outline: Validate complete data for cashrewards campaign for QLD - new moving customer
    ...
    Examples:
      ...
      |New           |ELE     |20         |cashrewards  |E2E_Campaign_cashrewards_QLD_new_moving |QLD  |Quote Tool    |Move Home|No   |No  |RES          |New            |
  ...
  Scenario Outline: Validate complete data for cashrewards campaign for SA - new moving
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign   |folderName                                 |state|sourceSystem  |journey    |AAH  |DD  |customerType |newOrExisting  |
      |New           |BOTH    |14         |14         |cashrewards|E2E_Campaign_cashrewards_SA_new_moving |SA   |Quote Tool    |Move Home  |No   |No  |RES          |New            |
  ...
  Scenario Outline: Validate complete data for cashrewards campaign for VIC - new moving
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign   |folderName                              |state |sourceSystem  |journey    |AAH  |DD  |customerType |newOrExisting  |
      |New           |BOTH    |13         |33         |cashrewards|E2E_Campaign_cashreward_VIC_new_moving |VIC   |Quote Tool    |Move Home  |No   |No  |RES          |New            |
  ...
  Scenario Outline: Validate complete data for cashrewards campaign for VIC existing non moving
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign    |folderName                                       |state|sourceSystem  |journey    |AAH  |DD  |customerType |newOrExisting        |
      |Existing      |BOTH    |13         |33         |cashrewards |E2E_Campaign_cashrewards_VIC_existing_non-moving |VIC  |Quote Tool    |Plan Switch|No   |No  |RES          |Existing  non-moving |
  @campaign21.4.3
  Scenario Outline: Validate complete data for cashrewards campaign for NSW existing non moving
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign    |folderName                                       |state|sourceSystem  |journey    |AAH  |DD  |customerType |newOrExisting        |
      |Existing      |BOTH    |24         |24         |cashrewards |E2E_Campaign_cashrewards_NSW_existing_non-moving |NSW  |Quote Tool    |Plan Switch|No   |No  |RES          |Existing  non-moving |
  ...
  Scenario Outline: Validate complete data for cashrewards campaign for SA existing non moving
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign    |folderName                                       |state|sourceSystem  |journey    |AAH  |DD  |customerType |newOrExisting        |
      |Existing      |BOTH    |14         |14         |cashrewards |E2E_Campaign_cashrewards_SA_existing_non-moving |SA  |Quote Tool    |Plan Switch|No   |No  |RES          |Existing  non-moving |
  ...
  Scenario Outline: Validate complete data for cashrewards campaign for QLD existing non moving
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|campaign    |folderName                                       |state|sourceSystem  |journey    |AAH  |DD  |customerType |newOrExisting        |
      |Existing      |ELE    |20         |cashrewards |E2E_Campaign_cashrewards_QLD_existing_non-moving |QLD  |Quote Tool    |Plan Switch|No   |No  |RES          |Existing  non-moving |
