...
Feature:E2E scenario for residential-flexi-plan
  ...
  Scenario Outline: Validate complete data for residential-Flexi-plan for NSW-Ausgrid for new moving customer
    ...
    Examples:
      ...
      |New           |BOTH    |Flexi Plan |20          |16         |flexi    | NSW   |E2E_resi-flexi-plan_NSW_new_moving   |Quote Tool  |Move Home|NSW    |RES          |New            |No  |No  |
  ...
  Scenario Outline: Validate complete data for residential-Flexi-plan for QLD - new moving customer
    ...
    Examples:
      ...
      | New            | ELE      |Flexi Plan| 12          | flexi    | E2E_resi-flexi-plan_QLD_new_moving | QLD   | Quote Tool   | Move Home | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for residential-Flexi-plan for SA - new non moving
    ...
    Examples:
      ...
      | New            | BOTH     |Flexi Plan| 6           | 15          | flexi    | E2E_resi-flexi-plan_SA_new_nonmoving | SA    | Quote Tool   | COR     | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for residential-Flexi-plan for ACT - new moving
    ...
    Examples:
      | customerStatus | fuelType |planName  | eleDiscount | gasDiscount | campaign | folderName                        | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | ELE      |Flexi Plan| 10          | 15          | flexi    | E2E_resi-flexi-plan_ACT_new_moving | ACT   | Quote Tool   | Move Home | No  | No | RES          | New           |
  @DR22.5.5.campaign
...
#    And user selects answer for property renovation question for '<state>'
    ...
    Examples:
      | customerStatus | fuelType |planName  | eleDiscount | gasDiscount | campaign | folderName                             | state | sourceSystem | journey | AAH | DD | customerType | newOrExisting |
      | New            | ELE      |Flexi Plan| 10          | 15          | flexi    | E2E_resi-flexi-plan_ACT_new_nonmove | ACT   | Quote Tool   | COR     | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for residential-Flexi-plan for ACT - existing non-moving
    ...
    Examples:
      | customerStatus | fuelType |planName  | eleDiscount | gasDiscount | campaign | folderName                             | state | sourceSystem | journey | AAH | DD | customerType | newOrExisting |
      | Existing       | ELE      |Flexi Plan| 10          | 15          | flexi    | E2E_resi-flexi-plan_ACT_Exs_nonmove | ACT   | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
  ...
  Scenario Outline: Validate complete data for residential-Flexi-plan for VIC - new moving
    ...
    Examples:
      | customerStatus | fuelType |planName  | eleDiscount | gasDiscount | campaign | folderName                        | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     |Flexi Plan| 6           | 17          | flexi    | E2E_resi-flexi-plan_VIC_new_moving | VIC   | Quote Tool   | Move Home | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for residential-Flexi-plan for VIC - new non-moving
    ...
    Examples:
      | customerStatus | fuelType |planName  | eleDiscount | gasDiscount | campaign | folderName                        | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     |Flexi Plan| 6           | 17          | flexi    | E2E_resi-flexi-plan_VIC_new_non_moving | VIC   | Quote Tool   | COR   | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for residential-Flexi-plan for NSW-Endeavour - new non moving customer
    ...
    Examples:
      | customerStatus | fuelType |planName  | eleDiscount | gasDiscount | campaign | folderName                           | state | sourceSystem | journey | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     |Flexi Plan| 16          | 16          | flexi    | E2E_resi-flexi-plan_NSW_new_nonmoving | NSW   | Quote Tool   | COR     | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for residential-Flexi-plan for VIC existing non moving
    ...
    Examples:
      | customerStatus | fuelType |planName  | eleDiscount | gasDiscount | campaign | folderName                                 | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     |Flexi Plan| 6           | 17          | flexi    | E2E_resi-flexi-plan_VIC_existing_non-moving | VIC   | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
  ...
  Scenario Outline: Validate complete data for residential-Flexi-plan for VIC existing moving
    ...
    Examples:
      | customerStatus | fuelType |planName  | eleDiscount | gasDiscount | campaign | folderName                             | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     |Flexi Plan| 6           | 17          | flexi    | E2E_resi-flexi-plan_VIC_existing_moving | VIC   | Quote Tool   | Move Home | No  | No | RES          | Existing  non-moving |
...
#      | <customerStatus> | 6942134043    | Postcode            | 2529             | dob    | 01011980 |
    ...
    Examples:
      | customerStatus | fuelType |planName  | eleDiscount | gasDiscount | campaign | folderName                                 | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     |Flexi Plan| 16          | 16          | flexi    | E2E_resi-flexi-plan_NSW_existing_non-moving | NSW   | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
  ...
  Scenario Outline: Validate complete data for residential-Flexi-plan for SA existing non moving
    ...
    Examples:
      | customerStatus | fuelType |planName  | eleDiscount | gasDiscount | campaign | folderName                                | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     |Flexi Plan| 6           | 15          | flexi    | E2E_resi-flexi-plan_SA_existing_non-moving | SA    | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
  ...
  Scenario Outline: Validate complete data for residential-Flexi-plan for QLD existing non moving
    ...
    Examples:
      | customerStatus | fuelType |planName  | eleDiscount | campaign | folderName                                 | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | ELE      |Flexi Plan| 12          | flexi    | E2E_resi-flexi-plan_QLD_existing_non-moving | QLD   | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
