...
Feature:E2E scenario for fca campaign

  Scenario Outline: Validate complete data for fca campaign for NSW
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    When user provides "FCAOFFER" and "2010" and clicks on show me plan link
    ...
    Examples:
      ...
      |New           |BOTH    |22         |20         |fca        |E2E_Campaign_fca_NSW |Quote Tool  |Move Home|NSW    |BUS          |New            |No  |No  |


  Scenario Outline: Validate complete data for fca campaign for VIC
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    When user provides "FCAOFFER" and "3355" and clicks on show me plan link
    Then user is presented with the plans
    And user validates "ELE" discount to be "<eleDiscount>" percent
    And user validates "GAS" discount to be "<gasDiscount>" percent
    And user validates the data on plans page for "<campaign>"
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign |folderName           |sourceSystem|journey  |state  |customerType |newOrExisting  |AAH |DD  |
      |New           |BOTH    |6          |24         |fca      |E2E_Campaign_fca_VIC |Quote Tool  |Move Home|VIC    |BUS          |New            |No  |No  |

  Scenario Outline: Validate complete data for fca campaign for SA
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign |folderName           |sourceSystem|journey  |state  |customerType |newOrExisting  |AAH |DD  |
      |New           |BOTH    |4          |4          |fca      |E2E_Campaign_fca_SA  |Quote Tool  |Move Home|SA     |BUS          |New            |No  |No  |

  Scenario Outline: Validate complete data for fca campaign for ACT
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    When user provides "FCAOFFER" and "2612" and clicks on show me plan link
    Then user is presented with the plans
    And user validates "ELE" discount to be "<eleDiscount>" percent
    And user validates "GAS" discount to be "<gasDiscount>" percent
    And user validates the data on plans page for "<campaign>"
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign |folderName           |sourceSystem|journey  |state  |customerType |newOrExisting  |AAH |DD  |
      |New           |BOTH    |11         |19         |fca      |E2E_Campaign_fca_ACT |Quote Tool  |Move Home|ACT    |BUS          |New            |No  |No  |

  Scenario Outline: Validate complete data for fca campaign for QLD
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    When user provides "FCAOFFER" and "4020" and clicks on show me plan link
    Then user is presented with the plans
    And user validates "ELE" discount to be "<eleDiscount>" percent
    And user validates the data on plans page for "<campaign>"
      |fuelType |Feature_50Credit  |Feature_carbonNeutral   |Feature_peaceOfMind  |Feature_discountOffTotalEnergyBill   |Feature_noStandardConnectionFee  |
    ...
    Examples:
      ...
      |New           |ELE     |14         |fca       |E2E_Campaign_fca_QLD |Quote Tool  |Move Home|QLD    |BUS          |New            |No  |No  |
