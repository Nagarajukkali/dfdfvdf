...
Feature:E2E scenario for total-plan-plus campaign
  ...
  Scenario Outline: Validate complete data for total-plan-plus campaign for VIC - existing non moving
    ...
    Examples:
      ...
      | Existing       | BOTH     | 12          | 27          | total-plan-plus | E2E_Campaign_total-plan-plus_VIC_exis_nonmov | VIC   | Quote Tool   | Plan Switch | No  | No | RES          | Existing      |
  ...
  Scenario Outline: Validate complete data for total-plan-plus campaign for SA - existing non moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign        | folderName                                  | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting |
      | Existing       | ELE      | 7           | 13          | total-plan-plus | E2E_Campaign_total-plan-plus_SA_exis_nonmov | SA    | Quote Tool   | Plan Switch | No  | No | RES          | Existing      |
@DR21.7.5.campaign
  Scenario Outline: Validate complete data for total-plan-plus campaign for ACT - existing non moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign        | folderName                                   | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting |
      | Existing       | ELE      | 13          | 17          | total-plan-plus | E2E_Campaign_total-plan-plus_ACT_exis_nonmov | ACT   | Quote Tool   | Plan Switch | No  | No | RES          | Existing      |
  ...
  Scenario Outline: Validate complete data for total-plan-plus campaign for NSW - new moving customer
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign        | folderName                                  | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 17          | 17          | total-plan-plus | E2E_Campaign_total-plan-plus_NSW_new_moving | NSW   | Quote Tool   | Move Home | No  | No | RES          | New           |
...
@DR21.7.5.campaign
  Scenario Outline: Validate complete data for total-plan-plus campaign for VIC - new moving customer
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign        | folderName                                  | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 12          | 27          | total-plan-plus | E2E_Campaign_total-plan-plus_VIC_new_moving | VIC   | Quote Tool   | Move Home | No  | No | RES          | New           |