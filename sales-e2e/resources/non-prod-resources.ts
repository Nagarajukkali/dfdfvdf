...
config: {
    env: 'non-prod',
    eaHomePageUrl: 'https://latte.nonprod.digital.energyaustralia.com.au?live=disabled',
    ...
    qt2ReportingURL:'https://latte.nonprod.digital.energyaustralia.com.au/qt2reporting/login',
    qt2ReportingHomePageURL:'https://latte.nonprod.digital.energyaustralia.com.au/qt2reporting/app/reporting'
  },
  testData: {
    mastercard: {
