...
Feature:E2E scenario for offer-canstarblue campaign
  ...
  Scenario Outline: Validate complete data for offer-canstarblue campaign for NSW - new moving customer
    ...
    Examples:
      ...
      |New           |BOTH    |15         |15         |offer-canstarblue     |E2E_Campaign_offer-canstarblue_NSW_new_moving  |NSW  |Quote Tool    |Move Home|No   |No  |RES          |New            |
  ...
  Scenario Outline: Validate complete data for offer-canstarblue campaign for QLD - new moving customer
    ...
    Examples:
      ...
      |New           |ELE     |13         |offer-canstarblue  |E2E_Campaign_offer-canstarblue_QLD_new_moving |QLD  |Quote Tool    |Move Home|No   |No  |RES          |New            |
  ...
  Scenario Outline: Validate complete data for offer-canstarblue campaign for NSW existing non moving
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign    |folderName                                       |state|sourceSystem  |journey    |AAH  |DD  |customerType |newOrExisting        |
      |Existing      |BOTH    |15         |15         |offer-canstarblue |E2E_Campaign_offer-canstarblue_NSW_existing_non-moving |NSW  |Quote Tool    |Plan Switch|No   |No  |RES          |Existing  non-moving |
  ...
  Scenario Outline: Validate complete data for offer-canstarblue campaign for QLD existing non moving
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|campaign    |folderName                                       |state|sourceSystem  |journey    |AAH  |DD  |customerType |newOrExisting        |
      |Existing      |ELE    |13         |offer-canstarblue |E2E_Campaign_offer-canstarblue_QLD_existing_non-moving |QLD  |Quote Tool    |Plan Switch|No   |No  |RES          |Existing  non-moving |
