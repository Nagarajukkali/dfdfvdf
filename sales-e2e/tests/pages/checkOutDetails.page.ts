...
const eaCheckoutDetailsPage = {
  elements: {
    ...
    eleDisconnectionError: Selector("#electricity-calendar-error[class='hs-disconnection']"),
    gasDisconnectionError: Selector("#gas-calendar-error[class='hs-disconnection']"),
    ...
    flexiElePlan: Selector("[id*='plan-select-button-BP2H-E']"),
    ...
    balanceEleBusiness: Selector("[id*='plan-select-button-BSPB2-E']"),
    ...
    flexiGasPlan: Selector("[id*='plan-select-button-BP2H-G']"),
    ...
    chkboxContactPreference: Selector("[id*='ContactPreferenceModalId'] label"),
