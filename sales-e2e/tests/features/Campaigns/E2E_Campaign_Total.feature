...
Feature:E2E scenario for total campaign
  ...
  Scenario Outline: Validate complete data for total campaign for VIC - new moving
    ...
    Examples:
      ...
      | New            | BOTH     | 12          | 24          | total    | E2E_Campaign_cashreward_VIC_new_moving | VIC   | Quote Tool   | Move Home | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for cashrewards campaign for NSW-Ausgrid - new moving customer
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign    | folderName                              | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | ELE      | 18          | 16          | total       | E2E_Campaign_total_NSW_new_moving | NSW   | Quote Tool   | Move Home | No  | No | RES          | New           |
