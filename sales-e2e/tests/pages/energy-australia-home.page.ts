...
const eaHomePage={
  ...
  elements: {
    ...
    basicHomeReferencePrice:Selector("#plan-price-reference-RSOT span"),
    basicBusinessReferencePrice:Selector("#plan-price-reference-BSOT span"),
    noFrillsComparisonStatement:Selector("#plan-price-reference-RCPP span"),
    totalPlanComparisonStatement:Selector("#plan-price-reference-TOPH span"),
    totalPlanPlusComparisonStatement:Selector("#plan-price-reference-SWSR1 span"),
    totalPlanBusinessComparisonStatement:Selector("#plan-price-reference-TOPB span"),
    totalPlanPlusBusinessComparisonStatement:Selector("#plan-price-reference-SWSRB span"),
    disclaimer: {
