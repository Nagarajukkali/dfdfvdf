...
Feature:E2E scenario for loyalty-boomerang campaign
  ...
  Scenario Outline: Validate complete data for loyalty-boomerang campaign for NSW-Ausgrid - new moving customer
    ...
    Examples:
      ...
      | New            | ELE      | 18          | 16          | loyalty-boomerang | E2E_Campaign_cashrewards_NSW_new_moving | NSW   | Quote Tool   | Move Home | No  | No | RES          | New           |
  ...
  @DR21.11.4.campaign
  Scenario Outline: Validate complete data for loyalty-boomerang campaign for NSW-Essential existing non moving
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
