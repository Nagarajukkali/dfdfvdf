...
Feature:E2E scenario for business-industryoffer campaign
    ...
    Scenario Outline: Validate complete data for business-industryoffer campaign for NSW
      ...
      And user selects mailing address option
        ...
        Examples:
            ...
            | New            | BOTH     | 22          | 20          | business-industryoffer | E2E_Campaign_business-industryoffer_NSW | Quote Tool   | Move Home | NSW   | BUS          | New           | No  | No |
    ...
    Scenario Outline: Validate complete data for business-industryoffer campaign for VIC
      ...
      And user selects mailing address option
        ...
        Examples:
            | customerStatus | fuelType | eleDiscount | gasDiscount | campaign               | folderName                              | sourceSystem | journey   | state | customerType | newOrExisting | AAH | DD |
            | New            | BOTH     | 6           | 24          | business-industryoffer | E2E_Campaign_business-industryoffer_VIC | Quote Tool   | Move Home | VIC   | BUS          | New           | No  | No |
    ...
    Scenario Outline: Validate complete data for business-industryoffer campaign for SA
      ...
      And user selects mailing address option
        ...
        Examples:
            | customerStatus | fuelType | eleDiscount | gasDiscount | campaign               | folderName                             | sourceSystem | journey   | state | customerType | newOrExisting | AAH | DD |
            | New            | BOTH     | 4           | 4           | business-industryoffer | E2E_Campaign_business-industryoffer_SA | Quote Tool   | Move Home | SA    | BUS          | New           | No  | No |
    ...
    Scenario Outline: Validate complete data for business-industryoffer campaign for ACT
      ...
      And user selects mailing address option
        ...
        Examples:
            | customerStatus | fuelType | eleDiscount | gasDiscount | campaign               | folderName                              | sourceSystem | journey   | state | customerType | newOrExisting | AAH | DD |
            | New            | BOTH     | 11          | 19          | business-industryoffer | E2E_Campaign_business-industryoffer_ACT | Quote Tool   | Move Home | ACT   | BUS          | New           | No  | No |
    ...
    Scenario Outline: Validate complete data for business-industryoffer campaign for QLD
      ...
      And user selects mailing address option
        ...
        Examples:
            ...
            | New            | ELE      | 14          | business-industryoffer | E2E_Campaign_business-industryoffer_QLD | Quote Tool   | Move Home | QLD   | BUS          | New           | No  | No |
