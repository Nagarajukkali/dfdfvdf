...
Feature:E2E scenario for comeback campaign
  ...
  Scenario Outline: Validate complete data for comeback campaign for NSW-Ausgrid - new moving
    ...
    Examples:
      ...
      | New            | ELE      | 19          | 17          | comeback | E2E_Campaign_Comeback_NSW_new_moving | NSW   | Quote Tool   | Move Home | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for comeback campaign for ACT - new moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                           | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | ELE      | 11          | 16          | comeback | E2E_Campaign_Comeback_ACT_new_moving | ACT   | Quote Tool   | Move Home | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for comeback campaign for VIC - new moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                           | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 13          | 25          | comeback | E2E_Campaign_Comeback_VIC_new_moving | VIC   | Quote Tool   | Move Home | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for comeback campaign for SA - new moving
    ...
    And user validates below mandatory fields
      | fuelType | quoteStatus      | customerType | offerType | planCode | NMI        | renovationsSinceDeenergisation | renovationsInProgressOrPlanned | customerWithLifeSupport | lifeSupportEquipmentType | billRouteType | customerStatus   | campaign   |
      | ELE      | VERBALLYACCEPTED | RESIDENTIAL  | ENE       | SWSR1-ES | 2001245279 |                                |                                | N                       |                          | EMAIL         | <customerStatus> | <campaign> |
    And user validates all the details for 'GAS' submitted quote
    And user validates below mandatory fields
      | fuelType | quoteStatus      | customerType | offerType | planCode | MIRN       | renovationsSinceDeenergisation | renovationsInProgressOrPlanned | customerWithLifeSupport | lifeSupportEquipmentType | billRouteType | customerStatus   | campaign   |
      | GAS      | VERBALLYACCEPTED | RESIDENTIAL  | ENE       | SWSR1-GS | 5510149276 |                                |                                | N                       |                          | EMAIL         | <customerStatus> | <campaign> |
    Examples:
      ...
      | New            | BOTH     | 7           | 16          | comeback | E2E_Campaign_Comeback_SA_new_moving | SA    | Quote Tool   | Move Home | No  | No | RES          | New           | VERBALLYACCEPTED |
  ...
  Scenario Outline: Validate complete data for comeback campaign for QLD - new moving
    ...
    Examples:
      ...
      | New            | ELE      | 13          | comeback | E2E_Campaign_Comeback_QLD_new_moving | QLD   | Quote Tool   | Move Home | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for comeback campaign for VIC - existing non moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                            | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting |
      | Existing       | BOTH     | 13          | 25          | comeback | E2E_Campaign_Comeback_VIC_exis_nonmov | VIC   | Quote Tool   | Plan Switch | No  | No | RES          | Existing      |

  @DR21.11.4.campaign
  Scenario Outline: Validate complete data for comeback campaign for NSW-Essential - existing non moving
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
...
#      | GAS      | Y                | Y                     | Y                   | Y                                  | <state> |
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                            | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting |
      | Existing       | BOTH     | 17          | 17          | comeback | E2E_Campaign_Comeback_NSW_exis_nonmov | NSW   | Quote Tool   | Plan Switch | No  | No | RES          | Existing      |
  ...
  Scenario Outline: Validate complete data for comeback campaign for SA - existing non moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                           | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting |
      | Existing       | BOTH     | 7           | 16          | comeback | E2E_Campaign_Comeback_SA_exis_nonmov | SA    | Quote Tool   | Plan Switch | No  | No | RES          | Existing      |
  ...
  Scenario Outline: Validate complete data for comeback campaign for ACT - existing non moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                            | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting |
      | Existing       | BOTH     | 11          | 16          | comeback | E2E_Campaign_Comeback_ACT_exis_nonmov | ACT   | Quote Tool   | Plan Switch | No  | No | RES          | Existing      |
  ...
  Scenario Outline: Validate complete data for comeback campaign for QLD - existing non moving
    ...
    And user validates below mandatory fields
      | fuelType | quoteStatus      | customerType | offerType | planCode | NMI        | renovationsSinceDeenergisation | renovationsInProgressOrPlanned | customerWithLifeSupport | lifeSupportEquipmentType | billRouteType | customerStatus   | campaign   |
      | ELE      | VERBALLYACCEPTED | RESIDENTIAL  | COR       | SWSR1-EQ | QB01405934 |                                |                                | N                       |                          | EMAIL         | <customerStatus> | <campaign> |
    Examples:
      | customerStatus | fuelType | eleDiscount | campaign | folderName                            | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting |
      | Existing       | ELE      | 13          | comeback | E2E_Campaign_Comeback_QLD_exis_nonmov | QLD   | Quote Tool   | Plan Switch | No  | No | RES          | Existing      |
