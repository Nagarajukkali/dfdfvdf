...
Feature:E2E scenario for movehouse campaign
  ...
  Scenario Outline: Validate complete data for movehouse campaign for NSW
    ...
    Examples:
      ...
      |New           |BOTH    |17         |17         |movehouse |E2E_Campaign_MoveHouse_NSW  |NSW  |Quote Tool    |Move Home|No   |No  |RES          |New            |

  Scenario Outline: Validate complete data for movehouse campaign for VIC
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign  |folderName                 |state|sourceSystem  |journey  |AAH  |DD  |customerType |newOrExisting  |
      |New           |BOTH    |11         |27         |movehouse |E2E_Campaign_MoveHouse_VIC |VIC  |Quote Tool    |Move Home|No   |No  |RES          |New            |

  Scenario Outline: Validate complete data for movehouse campaign for QLD
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    ...
    Examples:
      ...
      |New           |ELE     |13         |movehouse|E2E_Campaign_MoveHouse_QLD |QLD  |Quote Tool    |Move Home|No   |No  |RES          |New            |

  Scenario Outline: Validate complete data for movehouse campaign for ACT
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign  |folderName                  |state|sourceSystem  |journey  |AAH  |DD  |customerType |newOrExisting  |
      |New           |BOTH    |9          |9          |movehouse |E2E_Campaign_movehouse_ACT  |ACT  |Quote Tool    |Move Home|No   |No  |RES          |New            |

  Scenario Outline: Validate complete data for movehouse campaign for SA
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign   |folderName                |state|sourceSystem  |journey  |AAH  |DD  |customerType |newOrExisting  |
      |New           |BOTH    |6          |15         |movehouse  |E2E_Campaign_movehouse_SA |SA   |Quote Tool    |Move Home|No   |No  |RES          |New            |
