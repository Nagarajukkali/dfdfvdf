...
const eaCheckoutReviewPage = {
  elements: {
    ...
    eleFeatureMoveHome: Selector("#reviewSectionEle [id*='benefit-text']").withText("Move Home Credit"),
    gasFeatureMoveHome: Selector("#reviewSectionGas [id*='benefit-text']").withText("Move Home Credit"),
