...
Feature:E2E scenario for offer-finder campaign
  ...
  Scenario Outline: Validate complete data for offer-finder campaign for SA - new moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign     | folderName                              | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 6           | 12          | offer-finder | E2E_Campaign_offer-finder_SA_new_moving | SA    | Quote Tool   | Move Home | No  | No | RES          | New           |
@DR21.7.5.campaign
  ...
  Scenario Outline: Validate complete data for offer-finder campaign for VIC - new non moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign     | folderName                                  | state | sourceSystem | journey | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 11          | 26          | offer-finder | E2E_Campaign_offer-finder_VIC_new_nonmoving | VIC   | Quote Tool   | COR     | No  | No | RES          | New           |
  @DR21.7.5.campaign
  Scenario Outline: Validate complete data for offer-finder campaign for VIC existing non moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign     | folderName                                        | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     | 11          | 26          | offer-finder | E2E_Campaign_offer-finder_VIC_existing_non-moving | VIC   | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
  ...
  Scenario Outline: Validate complete data for offer-finder campaign for SA existing non moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign     | folderName                                       | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     | 6           | 12          | offer-finder | E2E_Campaign_offer-finder_SA_existing_non-moving | SA    | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
