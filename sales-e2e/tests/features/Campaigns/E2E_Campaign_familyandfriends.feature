...
@DR21.7.5.campaign
  ...
  Scenario Outline: Validate complete data for familyandfriends campaign for VIC - new moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign         | folderName                                   | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 14          | 29          | familyandfriends | E2E_Campaign_familyandfriends_VIC_new_moving | VIC   | Quote Tool   | Move Home | No  | No | RES          | New           |
  @DR21.7.5.campaign
  Scenario Outline: Validate complete data for familyandfriends campaign for VIC existing non moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign         | folderName                                            | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     | 14          | 29          | familyandfriends | E2E_Campaign_familyandfriends_VIC_existing_non-moving | VIC   | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
