...
const cartsPage = {
  elements: {
    ...
    eleFeatureMoveHome: Selector("#cart-plan-ELE .cart-plan__details-text").withText("Move Home Credit"),
    ...
    gasFeatureMoveHome: Selector("#cart-plan-GAS .cart-plan__details-text").withText("Move Home Credit"),
