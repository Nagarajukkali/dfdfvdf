...
const eaCheckoutReviewPage = {
  elements: {
    ...
    eleFeature50Credit: Selector("#reviewSectionEle [id*='benefit-text']").withText("sign up credit"),
    ...
    gasFeature50Credit: Selector("#reviewSectionGas [id*='benefit-text']").withText("sign up credit"),
