...
#      | GAS      | Y                | Y                     | N                   | Y                                  |  <state> |
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                           | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 5           | 12          | get-elec | E2E_Campaign_get-elec_NSW_new_moving | VIC   | Quote Tool   | Move Home | No  | No | RES          | New           |
...
#      | GAS      | Y                | Y                     | N                   | Y                                  |  <state> |
    ...
    And user validates below mandatory fields
      | fuelType | quoteStatus      | customerType | offerType | planCode | MIRN       | renovationsSinceDeenergisation | renovationsInProgressOrPlanned | customerWithLifeSupport | lifeSupportEquipmentType | billRouteType | customerStatus   | campaign   |
      | GAS      | VERBALLYACCEPTED | RESIDENTIAL  | PS        | BP2H-GV  | 5321873049 |                                |                                | N                       |                          | EMAIL         | <customerStatus> | <campaign> |
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                                   | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting |
      | Existing       | BOTH     | 5           | 12          | get-elec | E2E_Campaign_get-elec_VIC_existing_nonmoving | VIC   | Quote Tool   | Plan Switch | No  | No | RES          | Existing      |
...
#      | GAS      | Y                | Y                     | N                   | Y                                  |  <state> |
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                                | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | Existing       | BOTH     | 5           | 12          | get-elec | E2E_Campaign_get-elec_VIC_existing_moving | VIC   | Quote Tool   | Move Home | No  | No | RES          | Existing      |
