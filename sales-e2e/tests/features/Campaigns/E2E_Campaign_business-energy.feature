...
Feature:E2E scenario for business-energy campaign
  ...
  Scenario Outline: Validate complete data for business-energy campaign for NSW
    ...
    Examples:
      ...
      |New           |BOTH    |21         |19         |business-energy  |E2E_Campaign_business-energy_NSW |Quote Tool  |Move Home|NSW    |BUS          |New            |No  |No  |


  Scenario Outline: Validate complete data for business-energy campaign for VIC
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign         |folderName                       |sourceSystem|journey  |state  |customerType |newOrExisting  |AAH |DD  |
      |New           |BOTH    |5          |23         |business-energy  |E2E_Campaign_business-energy_VIC |Quote Tool  |Move Home|VIC    |BUS          |New            |No  |No  |

  Scenario Outline: Validate complete data for business-energy campaign for SA
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign          |folderName                   |sourceSystem|journey  |state  |customerType |newOrExisting  |AAH |DD  |
      |New           |BOTH    |3          |3          |business-energy  |E2E_Campaign_business-energy_SA  |Quote Tool  |Move Home|SA     |BUS          |New            |No  |No  |

  Scenario Outline: Validate complete data for business-energy campaign for ACT
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign         |folderName                       |sourceSystem|journey  |state  |customerType |newOrExisting  |AAH |DD  |
      |New           |BOTH    |10         |19         |business-energy  |E2E_Campaign_business-energy_ACT |Quote Tool  |Move Home|ACT    |BUS          |New            |No  |No  |

  Scenario Outline: Validate complete data for business-energy campaign for QLD
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    ...
    Examples:
      ...
      |New           |ELE     |13         |business-energy  |E2E_Campaign_business-energy_QLD |Quote Tool  |Move Home|QLD    |BUS          |New            |No  |No  |
