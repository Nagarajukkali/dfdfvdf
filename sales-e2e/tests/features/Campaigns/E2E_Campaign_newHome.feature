...
Feature:E2E scenario for newhome campaign
  ...
  Scenario Outline: Validate complete data for newhome campaign for QLD - new moving customer
    ...
    Examples:
      ...
      | New            | ELE      | 14          | newhome    | E2E_Campaign_newhome_QLD_new_moving | QLD   | Quote Tool   | Move Home | No  | No | RES          | New           |
...
#    And user moves on to fill the qualifier
  ...
  Scenario Outline: Validate complete data for newhome campaign for QLD existing non moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | campaign | folderName                                 | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | ELE      | 14          | newhome    | E2E_Campaign_newhome_QLD_existing_non-moving | QLD   | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
