...
Feature:E2E scenario for get-gas campaign

  @DR23.6.14.campaign
  Scenario Outline: Validate complete data for get-gas campaign for NSW-Ausgrid - new moving customer
...
#      | GAS      | Y                | Y                     | N                   | Y                                  |  <state> |
    ...
    Examples:
      ...
      | New            | BOTH     | 10           | 8           | get-gas  | E2E_Campaign_get-gas_NSW_new_moving | NSW   | Quote Tool   | Move Home | No  | No | RES          | New           |

  @DR23.6.14.campaign
  Scenario Outline: Validate complete data for get-gas campaign for NSW-Endeavour - new non moving customer
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
...
#      | GAS      | Y                | Y                     | N                   | Y                                  |  <state> |
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                             | state | sourceSystem | journey | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 6           | 8           | get-gas  | E2E_Campaign_get-gas_NSW_new_nonmoving | NSW   | Quote Tool   | COR     | No  | No | RES          | New           |

  @DR23.6.14.campaign
  Scenario Outline: Validate complete data for get-gas campaign for NSW-Endeavour existing non moving customer
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    When user provides "2516" and clicks on show me plan link
    And user validates "ELE" discount to be "<eleDiscount>" percent
    And user validates "GAS" discount to be "<gasDiscount>" percent
...
#      | GAS      | Y                | Y                     | N                   | Y                                  |  <state> |
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                                  | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting |
      | Existing       | BOTH     | 6           | 8           | get-gas  | E2E_Campaign_get-gas_NSW_existing_nonmoving | NSW   | Quote Tool   | Plan Switch | No  | No | RES          | Existing      |

  @DR23.5.3.campaign
  Scenario Outline: Validate complete data for get-gas campaign for VIC - new moving customer
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
...
#      | GAS      | Y                | Y                     | N                   | Y                                  |  <state> |
    ...
    And user validates details on checkout review page
      ...
      | <sourceSystem> | <journey> | <fuelType> | <AAH> | <DD> | <customerType> | <newOrExisting> |
    And user validates plan details on review page for "<campaign>"
      | fuelType | Feature_50Credit | Feature_carbonNeutral | Feature_peaceOfMind | Feature_XX_discountOffTotalEnergyBill |Feature_regularPayOption| Feature_noStandardConnectionFee | Feature_variableRates | state   |
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                          | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 11           | 25          | get-gas  | E2E_Campaign_get-gas_NSW_new_moving | VIC   | Quote Tool   | Move Home | No  | No | RES          | New           |

  @DR23.5.3.campaign
  Scenario Outline: Validate complete data for get-gas campaign for VIC existing non moving customer
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    When user provides "3000" and clicks on show me plan link
    And user validates "ELE" discount to be "<eleDiscount>" percent
    And user validates "GAS" discount to be "<gasDiscount>" percent
...
#      | GAS      | Y                | Y                     | N                   | Y                                  |  <state> |
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                                  | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting |
      | Existing       | BOTH     | 11           | 25          | get-gas  | E2E_Campaign_get-gas_VIC_existing_nonmoving | VIC   | Quote Tool   | Plan Switch | No  | No | RES          | Existing      |

  @DR23.5.3.campaign
  Scenario Outline: Validate complete data for get-gas campaign for VIC existing moving customer
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    When user provides "3000" and clicks on show me plan link
    And user validates "ELE" discount to be "<eleDiscount>" percent
    And user validates "GAS" discount to be "<gasDiscount>" percent
...
#      | GAS      | Y                | Y                     | N                   | Y                                  |  <state> |
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                               | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | Existing       | BOTH     | 11           | 25          | get-gas  | E2E_Campaign_get-gas_VIC_existing_moving | VIC   | Quote Tool   | Move Home | No  | No | RES          | Existing      |

  @DR22.9.2.campaign
  Scenario Outline: Validate complete data for get-gas campaign for QLD
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    ...
    Examples:
      | campaign | folderName               |
      | get-gas  | E2E_Campaign_get-gas_QLD |

  @DR22.9.2.campaign
  Scenario Outline: Validate complete data for get-gas campaign for ACT
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    When user provides "2600" and clicks on show me plan link
    Then plans page load according to the type of 'CAMPAIGN_NOT_SERVICED'
    Examples:
      | campaign | folderName               |
      | get-gas  | E2E_Campaign_get-gas_ACT |

  @DR22.9.2.campaign
  Scenario Outline: Validate complete data for get-gas campaign for SA
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
    When user provides "5000" and clicks on show me plan link
    Then plans page load according to the type of 'CAMPAIGN_NOT_SERVICED'
    Examples:
      | campaign | folderName              |
      | get-gas  | E2E_Campaign_get-gas_SA |
