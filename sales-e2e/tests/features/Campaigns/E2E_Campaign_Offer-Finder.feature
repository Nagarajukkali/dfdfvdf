...
Feature:E2E scenario for offer-finder campaign
 ...
 @DR22.3.3.campaign
  ...
  #    | GAS      | N                | Y                     | Y                   | Y                                     | <state> |    Y                 |
   ...
   Examples:
      ...
      | New            | BOTH     | 20          | 16          | offer-finder | E2E_Campaign_offer-finder_NSW_new_moving | NSW   | Quote Tool   | Move Home | No  | No | RES          | New           |
 ...
 @DR22.3.3.campaign
  ...
  #    | ELE      | N                | Y                     | Y                   | Y                                     | <state> |    Y                 |
   ...
   Examples:
      ...
      | New            | ELE      | 14          | offer-finder | E2E_Campaign_offer-finder_QLD_new_moving | QLD   | Quote Tool   | Move Home | No  | No | RES          | New           |
 ...
 @DR22.1.2.campaign
  Scenario Outline: Validate complete data for offer-finder campaign for SA - new moving
   ...
   Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign     | folderName                              | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 6           | 15          | offer-finder | E2E_Campaign_offer-finder_SA_new_moving | SA    | Quote Tool   | COR       | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for offer-finder campaign for ACT - new moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign     | folderName                               | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 10          | 15          | offer-finder | E2E_Campaign_offer-finder_ACT_new_moving | ACT   | Quote Tool   | Move Home | No  | No | RES          | New           |
  ...
  #    | GAS      | N                | Y                     | Y                   | Y                                     | <state> |    Y                 |
   ...
   Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign     | folderName                                  | state | sourceSystem | journey | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 12          | 33          | offer-finder | E2E_Campaign_offer-finder_VIC_new_moving | VIC   | Quote Tool   | Move Home     | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for offer campaign for VIC - new non-moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign | folderName                        | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 12          | 33          | offer    | E2E_Campaign_offer-finder_VIC_new_non_moving | VIC   | Quote Tool   | COR   | No  | No | RES          | New           |
  ...
  #    | GAS      | N                | Y                     | Y                   | Y                                     | <state> |    Y                 |
   ...
   Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign     | folderName                                        | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     | 12          | 33          | offer-finder | E2E_Campaign_offer-finder_VIC_existing_non-moving | VIC   | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
  ...
  #    | GAS      | N                | Y                     | Y                   | Y                                     | <state> |    Y                 |
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign     | folderName                                    | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     | 12          | 33          | offer-finder | E2E_Campaign_offer-finder_VIC_existing_moving | VIC   | Quote Tool   | Move Home | No  | No | RES          | Existing  non-moving |
  ...
  # And user moves on to fill the qualifier
   ...
   Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign     | folderName                                        | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     | 16          | 16          | offer-finder | E2E_Campaign_offer-finder_NSW_existing_non-moving | NSW   | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
 ...
 @DR22.1.2.campaign
  Scenario Outline: Validate complete data for offer-finder campaign for SA existing non moving
   ...
   Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign     | folderName                                       | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | BOTH     | 6           | 15          | offer-finder | E2E_Campaign_offer-finder_SA_existing_non-moving | SA    | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
 ...
 @DR22.3.3.campaign
  ...
  #   | <customerStatus> | 4968819589    | Postcode            | 4077             | dob     | 01011980 |
   ...
   Examples:
      | customerStatus | fuelType | eleDiscount | campaign     | folderName                                        | state | sourceSystem | journey     | AAH | DD | customerType | newOrExisting        |
      | Existing       | ELE      | 14          | offer-finder | E2E_Campaign_offer-finder_QLD_existing_non-moving | QLD   | Quote Tool   | Plan Switch | No  | No | RES          | Existing  non-moving |
