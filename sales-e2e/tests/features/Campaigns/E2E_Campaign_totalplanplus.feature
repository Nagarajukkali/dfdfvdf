...
Feature:E2E scenario for total-plan-plus campaign
  ...
  Scenario Outline: Validate complete data for total-plan-plus campaign for VIC - existing non moving
    ...
    Examples:
      ...
      |Existing      |BOTH    |14         |34         |total-plan-plus    |E2E_Campaign_total-plan-plus_VIC_exis_nonmov    |VIC  |Quote Tool    |Plan Switch |No   |No  |RES          |Existing          |
  @campaign21.4.3
  Scenario Outline: Validate complete data for total-plan-plus campaign for NSW - existing non moving
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign           |folderName                   |state|sourceSystem  |journey     |AAH  |DD  |customerType |newOrExisting  |
      |Existing      |BOTH    |25         |25         |total-plan-plus    |E2E_Campaign_total-plan-plus_NSW_exis_nonmov    |NSW  |Quote Tool    |Plan Switch |No   |No  |RES          |Existing          |
  ...
  Scenario Outline: Validate complete data for total-plan-plus campaign for SA - existing non moving
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign    |folderName                   |state|sourceSystem  |journey     |AAH  |DD  |customerType |newOrExisting  |
      |Existing      |BOTH    |15         |15         |total-plan-plus    |E2E_Campaign_total-plan-plus_SA_exis_nonmov    |SA  |Quote Tool    |Plan Switch |No   |No  |RES          |Existing          |
  ...
  Scenario Outline: Validate complete data for total-plan-plus campaign for NSW - new moving customer
    ...
    Examples:
      |customerStatus|fuelType|eleDiscount|gasDiscount|campaign        |folderName                               |state|sourceSystem  |journey  |AAH  |DD  |customerType |newOrExisting  |
      |New           |BOTH    |25         |25         |total-plan-plus     |E2E_Campaign_total-plan-plus_NSW_new_moving  |NSW  |Quote Tool    |Move Home|No   |No  |RES          |New            |
