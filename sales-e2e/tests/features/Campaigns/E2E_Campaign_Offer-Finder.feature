...
Feature:E2E scenario for offer-finder campaign
  ...
  Scenario Outline: Validate complete data for offer-finder campaign for NSW-Ausgrid - new moving customer
    ...
    Examples:
      ...
      | New            | BOTH     | 18          | 16          | offer-finder | E2E_Campaign_offer-finder_NSW_new_moving | NSW   | Quote Tool   | Move Home | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for offer-finder campaign for SA - new moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign     | folderName                              | state | sourceSystem | journey   | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 6           | 15          | offer-finder | E2E_Campaign_offer-finder_SA_new_moving | SA    | Quote Tool   | Move Home | No  | No | RES          | New           |
  ...
  Scenario Outline: Validate complete data for offer-finder campaign for VIC - new non moving
    ...
    Examples:
      | customerStatus | fuelType | eleDiscount | gasDiscount | campaign     | folderName                                  | state | sourceSystem | journey | AAH | DD | customerType | newOrExisting |
      | New            | BOTH     | 12          | 24          | offer-finder | E2E_Campaign_offer-finder_VIC_new_nonmoving | VIC   | Quote Tool   | COR     | No  | No | RES          | New           |
  ...
  @DR21.11.4.campaign
  Scenario Outline: Validate complete data for offer-finder campaign for NSW-Essential existing non moving
    Given user has opened the '<campaign>' link in a browser and creates '<folderName>' to save evidences
